 ...
 *
 * However, if the incoming constraints are unbounded in exactly one dimension, it will constrain
 * that dimension to maintain the correct aspect ratio of the composition.
 */
@Stable
